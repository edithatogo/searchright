...
| 01 | [Contract catalogue and code generation](tracks/01-contract-catalog/spec.md) | foundation | source_implemented | source_implemented | compiler_verified | Maintain versioned schemas, examples, standards packs and Rust wire types from one catalogue. |
