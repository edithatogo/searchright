...
| 10 | [MCP stdio server MVP](tracks/10-mcp-mvp/spec.md) | mvp | source_implemented | source_implemented | compiler_verified | Expose typed, authority-annotated MCP tools over the same facade with stable structured outputs. |
