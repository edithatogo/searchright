...
| 09 | [CLI MVP](tracks/09-cli-mvp/spec.md) | mvp | source_implemented | source_implemented | source_verified | Expose stable scriptable operations through the shared application facade. |
