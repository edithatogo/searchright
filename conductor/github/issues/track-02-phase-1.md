<!-- searchright-issue-key: track-02-phase-1 -->
# Track 02 / Phase 1: Source implementation
...
- [x] T01: Implement and document every acceptance assertion with symbol- and test-level mappings. (`track-02-phase-1-task-01`)
