<!-- searchright-issue-key: track-13-phase-1 -->
# Track 13 / Phase 1: Source implementation
...
- [x] T01: Implement and document the track's source deliverables. (`track-13-phase-1-task-01`)
