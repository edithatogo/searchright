<!-- searchright-issue-key: track-05-phase-1 -->
# Track 05 / Phase 1: Source implementation
...
- [x] T01: Implement and document the track's source deliverables. (`track-05-phase-1-task-01`)
