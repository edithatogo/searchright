<!-- searchright-issue-key: track-09-phase-1 -->
# Track 09 / Phase 1: Source implementation
...
- [ ] T01: Complete every acceptance assertion; existing paths are scaffolding or partial implementation only. (`track-09-phase-1-task-01`)
