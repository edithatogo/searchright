...
- [x] Record machine-readable evidence without promoting live, downstream,
  optional-human or public-acceptance claims.
...
- [ ] Run the sealed five-role agent panel, preserve first-pass findings and dissent, and record accountable-owner adjudication.
...
- [ ] Obtain optional external human information-specialist calibration only when the accountable owner commissions it; record it as a separate evidence class rather than a default closure gate.
...
- [ ] Close the track only when applicable downstream, host/model, agent-panel,
  owner-adjudication and registry gates are evidenced. Optional external human
  calibration remains separate and does not block ordinary project closure.
