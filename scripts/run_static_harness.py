...
COMMANDS = [
    ...
    [sys.executable, "scripts/check_gate_catalog.py", "--check"],
    [sys.executable, "scripts/generate_evidence_debt.py", "--check"],
    ...
    [sys.executable, "scripts/check_provider_policies.py"],
    ...
    [sys.executable, "scripts/check_redaction_policy.py", "--self-test"],
    ...
    [sys.executable, "scripts/check_track_archival.py"],
